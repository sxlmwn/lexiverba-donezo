  ...
  return (
    ...
    >
      ...
      <div className={`flex items-center rounded-2xl px-4 py-2.5 w-[420px] border transition-all ${
        isDarkMode ? 'bg-[#18181b] border-[#27272a] focus-within:border-blue-500' : 'bg-slate-100/80 border-slate-200/60 focus-within:border-blue-600'
      }`}>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className={`w-10 h-10 rounded-full border flex items-center justify-center transition-colors shadow-2xs relative cursor-pointer ${
          isDarkMode ? 'bg-[#18181b] border-[#27272a] text-slate-300 hover:bg-zinc-800' : 'bg-white border-slate-200/80 text-slate-600 hover:bg-slate-50'
        }`}>
        ...
        >
          <img
            ...
            alt="Alex Sterling"
            className="w-10 h-10 rounded-full object-cover shadow-sm border border-slate-200 dark:border-zinc-700"
          />
