    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            <label className="block text-xs font-bold mb-1">Target Language Pair</label>
            <select
              className={`w-full px-4 py-2.5 rounded-xl border text-xs font-semibold outline-none ${
                isDarkMode ? 'bg-[#18181b] border-zinc-700 text-white' : 'bg-slate-50 border-slate-200'
              }`}
      ...
      >
        <div className="text-center py-6 space-y-4">
          ...
          <h4 className="font-bold text-sm">Drag and drop Translation Memory (.TMX, .XLIFF, .CSV)</h4>
      ...
      >
        <div className="text-center space-y-4 py-4">
          ...
          <div>
            <h4 className="font-extrabold text-base">Arc Company Review Session</h4>
      ...
      >
        <div className="text-center py-4 space-y-4">
          ...
          <h4 className="font-extrabold text-sm">LexiVerba iOS &amp; Android Companion</h4>
      ...
      >
        <div className="space-y-3 text-xs">
          ...
          <div className="p-3 bg-blue-600/10 border border-blue-500/30 rounded-xl font-semibold text-blue-500">
      ...
      >
        <div className="space-y-4 text-xs">
          {activeDetailItem?.badge && (
            <span className="inline-block bg-blue-600 text-white font-black text-[10px] px-3 py-1 rounded-full uppercase tracking-wider shadow-sm">
              {activeDetailItem.badge}
            </span>
          )}
          <div className="p-4 bg-slate-100 dark:bg-zinc-800/80 rounded-2xl border border-slate-200 dark:border-zinc-700/60 font-semibold leading-relaxed">
