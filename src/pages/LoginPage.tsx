          ...
          <div className={`w-full md:w-1/2 p-8 md:p-[64px] flex flex-col justify-center transition-colors ${
            ...
            >
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-slate-100 dark:bg-[#1a2234] rounded-xl font-medium text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600/20 transition-all border-none placeholder:text-slate-400"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 px-1 py-1">
                ...
                />
                <label htmlFor="remember" className="text-xs font-semibold text-slate-500 dark:text-slate-400 cursor-pointer">
            ...
            <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col items-center gap-4">
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Or continue with your institution</p>
